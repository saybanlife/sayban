...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: fC_9RAtGrwae/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__n39Yq)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames("all", sty.freeBox___7KEw)}>
            <div className={classNames("all", "__wab_text", sty.text__a4Lpk)}>
              <React.Fragment>
                {(() => {
                  try {
                    return $props.label;
        ...
        {(() => {
          ...
          <BaseText2
            ...
            slot={"description"}
          >
            <div className={classNames("all", "__wab_text", sty.text__soPue)}>
