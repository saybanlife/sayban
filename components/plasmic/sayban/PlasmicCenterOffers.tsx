...
function PlasmicCenterOffers__RenderFunc(props: {
  ...
  return (
    ...
    >
      <Embed
        className={classNames("__wab_instance", sty.embedHtml__sszy7)}
        code={
      ...
      >
        ...
        >
          <div className={classNames("all", sty.freeBox__uRq3E)}>
            <div
              className={classNames("all", sty.freeBox__wvZq, {
                [sty.freeBoxtop__wvZQo24Q6]: hasVariant($state, "top", "top")
              })}
            >
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__aiK0D, {
                  [sty.imgtop__aiK0Do24Q6]: hasVariant($state, "top", "top")
                })}
                displayHeight={"4rem"}
              ...
              <div
                className={classNames("all", "__wab_text", sty.text__nmNrm, {
                  [sty.texttop__nmNrMo24Q6]: hasVariant($state, "top", "top")
                })}
              >
                <React.Fragment>
              ...
              <div
                className={classNames("all", "__wab_text", sty.text__mteR6, {
                  [sty.texttop__mteR6O24Q6]: hasVariant($state, "top", "top")
                })}
              >
                <React.Fragment>{$props.subcatgori?.name}</React.Fragment>
              </div>
              <section
                className={classNames("all", sty.section___4QsE, {
                  [sty.sectiontop___4QsEO24Q6]: hasVariant($state, "top", "top")
                })}
              >
                <div
                  className={classNames(
                    ...
                    "fixed-box",
                    {
                      [sty.freeBoxtop__rSRppo24Q6]: hasVariant(
                        $state,
                        "top",
                        "top"
                      )
              ...
              {(() => {
                ...
                <div className={classNames("all", sty.freeBox___4Sm0L)}>
                  <div className={classNames("all", sty.freeBox__yfSZd)}>
                    <div
                      className={classNames(
                        "all",
                        "__wab_text",
                        sty.text__csoef,
                        {
                          [sty.texttop__csoefo24Q6]: hasVariant(
                            $state,
                            "top",
                            "top"
                          )
                  ...
                  <div className={classNames("all", sty.freeBox__dW7Bs)}>
                    <div className={classNames("all", sty.freeBox__fQvX9)}>
                      <Icon21Icon
                        className={classNames("all", sty.svg__lgRE)}
                        role={"img"}
                      />
                  ...
                  <div
                    className={classNames("all", "__wab_text", sty.text__ksHNg)}
                  >
                    {""}
                  </div>
                  ...
                  <div
                    className={classNames("all", "__wab_text", sty.text__yLXi)}
                  >
                    {""}
                  </div>
                  <div className={classNames("all", sty.freeBox__mxmza)}>
                    <div className={classNames("all", sty.freeBox__bf8WX)}>
                      <Icon22Icon
                        className={classNames("all", sty.svg__lS2G7)}
                        role={"img"}
                      />
                    ...
                    <div className={classNames("all", sty.freeBox__yElb3)}>
                      {(_par =>
                        !_par ? [] : Array.isArray(_par) ? _par : [_par])(
                        (() => {
                          try {
                        ...
                        return (
                          <div
                            className={classNames("all", sty.freeBox__x9ZU)}
                            key={currentIndex}
                          >
                            <MenuIcon
                  ...
                  <div className={classNames("all", sty.freeBox___68GBg)}>
                    <div className={classNames("all", sty.freeBox__sQ8Sm)}>
                      <Icon12Icon
                        className={classNames("all", sty.svg__hLptf)}
                        role={"img"}
                      />
                    ...
                    <div className={classNames("all", sty.freeBox__u1Ce)}>
                      <Iframe
              ...
              {(() => {
                ...
                <div className={classNames("all", sty.freeBox__gxx1I)}>
                  <div className={classNames("all", sty.freeBox__vwQi4)}>
                    {(() => {
                      try {
                      ...
                      <div className={classNames("all", sty.freeBox__hfun3)}>
                        <div className={classNames("all", sty.freeBox__cG4N)}>
                          <div
                            className={classNames("all", sty.freeBox__d0Rc2)}
                          >
                            <div
                              className={classNames(
                                "all",
...
`;
                        ...
                        <div className={classNames("all", sty.freeBox___6AiE6)}>
                          {(_par =>
                            !_par ? [] : Array.isArray(_par) ? _par : [_par])(
                            (() => {
                              try {
                    ...
                    {(() => {
                      ...
                      <div className={classNames("all", sty.freeBox__z3XL4)}>
                        <Icon43Icon
                          className={classNames("all", sty.svg__qDha0)}
                          role={"img"}
                        />
                  ...
                  <section className={classNames("all", sty.section__kDdxh)}>
                    <div
                      className={classNames(
                        "all",
                        sty.freeBox__hiFul,
                    ...
                    >
                      <Button
                        ...
                        color={"second"}
                          ...
                          <Icon63Icon
                            className={classNames("all", sty.svg__t5XA7)}
                            role={"img"}
                          />
                        }
                        iconEnd={true}
        ...
        <div className={classNames("all", sty.freeBox__ltjJ2)}>
          <div className={classNames("all", sty.freeBox__w7Hu)}>
            {(() => {
              ...
              <div className={classNames("all", sty.freeBox__nbYwb)}>
                <div
                  className={classNames("all", "__wab_text", sty.text___6Fq8)}
                >
                  <React.Fragment>
                    {$state.service?.price?.toLocaleString() + " تومان"}
                  </React.Fragment>
                </div>
                <div className={classNames("all", sty.freeBox__vGXfG)}>
                  <div
                    className={classNames("all", "__wab_text", sty.text__iljQd)}
                  >
                    <React.Fragment>
                      {(() => {
                        try {
            ...
            <div className={classNames("all", "__wab_text", sty.text__wuvl0)}>
              <React.Fragment>{$state.service.name}</React.Fragment>
            </div>
            <div className={classNames("all", "__wab_text", sty.text__pEyxg)}>
              <React.Fragment>
            ...
            <div className={classNames("all", sty.freeBox__qs5Tf)}>
              ...
              {(() => {
                ...
                <div className={classNames("all", sty.freeBox__gL4Xn)}>
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__nsKh5)}
                    displayHeight={"auto"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"100%"}
                    displayMinHeight={"0"}
