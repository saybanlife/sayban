  ...
  return (
    ...
    >
      ...
      <div className={classNames("all", sty.freeBox__nmu4Z)}>
        <div className={classNames("all", sty.freeBox__fwceu, "center")}>
