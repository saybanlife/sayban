...
import sty from "./PlasmicFilterSteff.module.css"; // plasmic-import: CRsyNfi2SPuL/css
...
export type PlasmicFilterSteff__VariantMembers = {
  fullpage: "fullpage";
  nopadding: "nopadding";
};
export type PlasmicFilterSteff__VariantsArgs = {
  fullpage?: SingleBooleanChoiceArg<"fullpage">;
  nopadding?: SingleBooleanChoiceArg<"nopadding">;
};
type VariantPropType = keyof PlasmicFilterSteff__VariantsArgs;
export const PlasmicFilterSteff__VariantProps = new Array<VariantPropType>(
  "fullpage",
  "nopadding"
);
...
export type PlasmicFilterSteff__OverridesType = {
...
function PlasmicFilterSteff__RenderFunc(props: {
  variants: PlasmicFilterSteff__VariantsArgs;
  args: PlasmicFilterSteff__ArgsType;
  overrides: PlasmicFilterSteff__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({
        [sty["pcls_FQABFRg-4PEp"]]: hasVariant(
          globalVariants,
          "screen",
          "mobileOnly"
        ),
        [sty["pcls_Hoo3nDI_5Cz6"]]: true,
        [sty["pcls_bC8vKxDUdpjB"]]: hasVariant($state, "fullpage", "fullpage")
      })}
      ...
      triggerSlot={
        <Button2
          ...
          endIcon={
            <ChevronLeftIcon
              className={classNames("all", sty.svg___740Iu)}
              role={"img"}
            />
          }
          ...
          startIcon={
            <ChevronRightIcon
              className={classNames("all", sty.svg__yRqLd)}
              role={"img"}
            />
          }
          submitsForm={false}
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames("all", "__wab_text", sty.text__xcMt)}>
            {"Sheet title"}
          </div>
        </DialogTitle>
        <div
          className={classNames("all", sty.freeBox__oNvUy, {
            [sty.freeBoxfullpage__oNvUy7IXtr]: hasVariant(
              $state,
              "fullpage",
              "fullpage"
            )
        ...
        >
          <div className={classNames("all", sty.freeBox__mDHuW)}>
            <div className={classNames("all", "__wab_text", sty.text__x49LI)}>
              {"\u0645\u0631\u062a\u0628 \u0633\u0627\u0632\u06cc "}
            </div>
            <SelectedComponnent
          ...
          <Line
            className={classNames("__wab_instance", sty.line__juzTv)}
            size={"small"}
          />

          <div
            className={classNames("all", sty.freeBox__sZh4Z, {
              [sty.freeBoxfullpage__sZh4Z7IXtr]: hasVariant(
                $state,
                "fullpage",
                "fullpage"
              )
          ...
          >
            <div
              className={classNames("all", "__wab_text", sty.text__gzk2D, {
                [sty.textfullpage__gzk2D7IXtr]: hasVariant(
                  $state,
                  "fullpage",
                  "fullpage"
                )
          ...
          <Line
            className={classNames("__wab_instance", sty.line__eIvQs, {
              [sty.linefullpage__eIvQs7IXtr]: hasVariant(
                $state,
                "fullpage",
                "fullpage"
              )
          ...
          <div className={classNames("all", sty.freeBox__qki0K)}>
            <div
              className={classNames("all", "__wab_text", sty.text__cu6Hk, {
                [sty.textfullpage__cu6Hk7IXtr]: hasVariant(
                  $state,
                  "fullpage",
                  "fullpage"
                )
            ...
            <SelectedComponnent
              ...
              className={classNames("__wab_instance", sty.availability, {
                [sty.availabilityfullpage]: hasVariant(
                  $state,
                  "fullpage",
                  "fullpage"
                )
              ...
              select={hasVariant($state, "fullpage", "fullpage") ? true : true}
              selected={generateStateValueProp($state, [
                "availability",
                "selected"
              ])}
          ...
          <Line
            className={classNames("__wab_instance", sty.line__hikzN)}
            size={"small"}
          />

          <div className={classNames("all", sty.freeBox__juuCe)}>
            <Button
              ...
              label={
                <div
                  className={classNames("all", "__wab_text", sty.text__siUrW)}
                >
                  {
                    "\u0627\u0639\u0645\u0627\u0644 \u0641\u06cc\u0644\u062a\u0631"
                  }
            ...
            <Button
              ...
              label={
                <div
                  className={classNames("all", "__wab_text", sty.text__obk56)}
                >
                  {"\u062d\u0630\u0641 \u0647\u0645\u0647"}
                </div>
              }
        ...
        >
          <XIcon className={classNames("all", sty.svg___8XCo)} role={"img"} />
        </DialogClose>
      </DialogContent>
    </Dialog>
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicFilterSteff__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicFilterSteff__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicFilterSteff__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicFilterSteff__ArgProps,
          internalVariantPropNames: PlasmicFilterSteff__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicFilterSteff__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "dialog3") {
    func.displayName = "PlasmicFilterSteff";
  } else {
    func.displayName = `PlasmicFilterSteff.${nodeName}`;
  }
  return func;
}

export const PlasmicFilterSteff = Object.assign(
  // Top-level PlasmicFilterSteff renders the root element
  makeNodeComponent("dialog3"),
  {
    ...
    // Metadata about props expected for PlasmicFilterSteff
    internalVariantProps: PlasmicFilterSteff__VariantProps,
    internalArgProps: PlasmicFilterSteff__ArgProps
  }
);

export default PlasmicFilterSteff;
/* prettier-ignore-end */
