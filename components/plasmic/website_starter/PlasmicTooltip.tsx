...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: Qb276Cell-HS/component
import { _useGlobalVariants } from "./plasmic"; // plasmic-import: qARqpE4p5tZmJuNxFbTaPz/projectModule
import { _useStyleTokens } from "./PlasmicStyleTokensProvider"; // plasmic-import: qARqpE4p5tZmJuNxFbTaPz/styleTokensProvider

import "@plasmicapp/react-web/lib/plasmic.css";

import sty from "./PlasmicTooltip.module.css"; // plasmic-import: oRIhemxW0CPo/css
...
function PlasmicTooltip__RenderFunc(props: {
  ...
  return (
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <div
                    className={classNames("all", "__wab_text", sty.text__aMj2R)}
                  >
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", "__wab_text", sty.text__ng2Xp)}>
            {"Hover me!"}
          </div>
        ),
        value: args.trigger,
