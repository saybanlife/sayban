...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 2MRRFY7jUAge/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: 4RgfxZWAffAT/icon
import Icon30Icon from "../sayban/icons/PlasmicIcon__Icon30"; // plasmic-import: 0iSVhpgUti5-/icon
    ...
    >
      {(
        ...
        <div
          ...
          className={classNames(projectcss.all, sty.softBackground, {
            ...
            [sty.softBackgroundloading]: hasVariant(
              $state,
              "loading",
              "loading"
            ),
      ...
      {(hasVariant($state, "type", "bordered") ? true : false) ? (
        <div
          ...
          className={classNames(projectcss.all, sty.border, {
            ...
            [sty.borderloading]: hasVariant($state, "loading", "loading"),
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.interactionEffect, {
          ...
          [sty.interactionEffectloading]: hasVariant(
            $state,
            "loading",
            "loading"
          ),
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__vNlPw, {
          ...
          [sty.freeBoxroundedFull__vNlPwyIw6A]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__vNlPWs2LWn]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__vNlPWu7B4Q]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__vNlPWuGoxx]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__vNlPw2L811]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__vNlPw7I5Cm]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__vNlPw7I5CmVfXuE]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__zuL6I, {
            [sty.freeBoxcolor_neutral__zuL6IafpkQ]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__zuL6IPa7Iw]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__zuL6Is2LWn]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__zuL6IuGoxx]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__zuL6I2L811]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__zuL6I7I5Cm]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__zuL6IdjFoAfpkQ]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__e502)}
                role={"img"}
              />
            ),
        ...
        {(hasVariant($state, "loading", "loading") ? false : true)
          ...
          : null}
        <div
          className={classNames(projectcss.all, sty.freeBox__dzv7U, {
            [sty.freeBoxiconEnd__dzv7UnkAf8]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__dzv7Us2LWn]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__dzv7UuGoxx]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__dzv7U2L811]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__iNOez)}
                role={"img"}
              />
            ),
