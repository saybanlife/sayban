...
import Label from "../../Label"; // plasmic-import: LG0etpgbA-e8/component
...
import Description from "../../Description"; // plasmic-import: inkUFaJSJuLM/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: PuCRKm4uZzqp/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__fx59T, {
          [sty.freeBoxiconEnd__fx59Tw8Ke]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__fx59TNOmd]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__fx59T3WL7B]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___0F0Lu, {
            [sty.freeBoxiconStart___0F0LuNOmd]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___0F0Lu3WL7B]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__qaVMs)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___8PiJe, {
            [sty.freeBoxiconEnd___8PiJew8Ke]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___8PiJeNOmd]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__qc2Ic)}
                role={"img"}
              />
            ),
