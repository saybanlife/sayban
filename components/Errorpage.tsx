...
} from "./plasmic/sayban/PlasmicErrorpage";
...
// Omit to hide them:
//
// interface ErrorpageProps extends Omit<DefaultErrorpageProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
// You can also stop extending from DefaultErrorpageProps altogether and have
// total control over the props for your component.
export interface ErrorpageProps extends DefaultErrorpageProps {}

function Errorpage_(props: ErrorpageProps, ref: HTMLElementRefOf<"div">) {
