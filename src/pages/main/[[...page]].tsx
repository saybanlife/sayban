...
// ۱. تعریف مسیرهایی که Next.js باید در زمان بیلد بسازد
export const getStaticPaths: GetStaticPaths = async () => {
  return {
    // آرایه خالی یعنی خود مسیر اصلی فولدر (مانند /main) هندل شود
    paths: [{ params: { mainPage: [] } }], 
    fallback: "blocking", // اگر مسیر جدیدی صدا زده شد، آن را همان موقع جنریت کند و 404 ندهد
  };
};

// ۲. تامین پراپس‌های مورد نیاز (حتی اگر خالی باشد، برای رندر استاتیک صفحات پویا الزامی است)
export const getStaticProps: GetStaticProps = async (context) => {
  return {
    props: {},
    revalidate: 60, // اختیاری: برای آپدیت شدن صفحه بدون بیلد مجدد (Incremental Static Regeneration)
  };
};
